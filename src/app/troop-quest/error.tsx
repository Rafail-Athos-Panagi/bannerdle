...
export default function TroopQuestErrorPage({ error, reset }: ErrorPageProps) {
  return (
    <div 
        ...
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <div className="bg-[var(--bannerlord-custom-very-dark-brown)] bg-opacity-90 rounded-lg p-6 mb-8 border-2 border-red-600" style={{
            ...
            <h2 className="text-xl font-semibold text-red-300 mb-4">
              The Armory Has Been Compromised
            </h2>
            <p className="text-[var(--bannerlord-custom-light-cream)] mb-4">
              Our troop database has encountered an unexpected error. The ancient scrolls of troop knowledge have been corrupted.
            </p>
          ...
          <div className="mt-8 text-sm text-[var(--bannerlord-custom-light-cream)] opacity-70">
            <p>Even the finest warriors face setbacks. Rise again, noble strategist!</p>
          </div>
        </div>
      </div>
    </div>
