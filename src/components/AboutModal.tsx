      ...
      >
        ...
        <div className="border-b-2 border-[#AF9767] py-3 px-4 sm:py-4 sm:px-6 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <h2 className="text-lg sm:text-2xl font-bold text-[#AF9767]">About Bannerdle</h2>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 max-h-[calc(100vh-8rem)] sm:max-h-[calc(90vh-12rem)] overflow-y-auto">
          ...
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-[#AF9767] mb-2 sm:mb-3 flex items-center">
              <FaGamepad className="mr-2 sm:w-5 sm:h-5" size={16} />
              Game Description
            </h3>
          ...
          <section>
            ...
            <div className="bg-[#1A0F08] border border-[#AF9767] rounded-lg p-3 sm:p-4">
              <p className="text-[#D4C4A8] text-xs sm:text-sm mb-3">
          ...
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-[#AF9767] mb-2 sm:mb-3 flex items-center">
              <FaHeart className="mr-2 sm:w-5 sm:h-5" size={16} />
              Inspired By
            </h3>
            <p className="text-[#D4C4A8] text-sm sm:text-base mb-3">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
               {[
                 ...
                 <div key={index} className="bg-[#1A0F08] border border-[#AF9767] rounded-lg p-2 sm:p-3 text-center">
                   <a 
                     href={game.url} 
                     target="_blank" 
          ...
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-[#AF9767] mb-2 sm:mb-3 flex items-center">
              <FaExternalLinkAlt className="mr-2 sm:w-5 sm:h-5" size={16} />
              Credits
            </h3>
             <div className="bg-[#1A0F08] border border-[#AF9767] rounded-lg p-3 sm:p-4">
               <p className="text-[#D4C4A8] text-xs sm:text-sm mb-2">
            ...
            <div className="bg-[#1A0F08] border border-[#AF9767] rounded-lg p-3 sm:p-4">
              ...
              <p className="text-[#D4C4A8] text-xs sm:text-sm mb-3">
               ...
               <button
                 ...
                 className="bg-[#AF9767] hover:bg-[#8B6F47] text-black font-bold py-2 px-3 sm:px-4 rounded transition-colors duration-200 flex items-center text-sm sm:text-base"
               >
          ...
          <section>
            <h3 className="text-lg sm:text-xl font-bold text-[#AF9767] mb-2 sm:mb-3 flex items-center">
              <FaCoffee className="mr-2 sm:w-5 sm:h-5" size={16} />
              Support the Game
            </h3>
            <div className="bg-[#1A0F08] border border-[#AF9767] rounded-lg p-3 sm:p-4 text-center">
              <p className="text-[#D4C4A8] text-xs sm:text-sm mb-4">
                If you want to support the game, you can buy me a coffee! ☕
              </p>
              <button
                onClick={handleDonationClick}
                className="bg-gradient-to-r from-[#AF9767] to-[#8B6F47] hover:from-[#8B6F47] hover:to-[#6B5A3A] text-black font-bold py-2 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-200 flex items-center mx-auto text-sm sm:text-base"
              >
          ...
          <section className="text-center">
            <div className="bg-gradient-to-r from-[#AF9767] to-[#8B6F47] rounded-lg p-4 sm:p-6">
              ...
              <p className="text-black text-xs sm:text-sm mt-3 font-semibold">
                by,
              </p>
        ...
        {/* Footer */}
        <div className="border-t-2 border-[#AF9767] py-3 px-4 sm:py-4 sm:px-6 text-center">
          <p className="text-[#8B6F47] text-xs sm:text-sm">
